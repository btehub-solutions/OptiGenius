        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Get comprehensive SEO & GEO analysis in seconds. Optimize for traditional search engines
              and AI-powered platforms like ChatGPT, Perplexity, and more.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-16">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-100 dark:border-gray-700">
              ...
              <h3 className="font-semibold text-lg mb-2 dark:text-white">Deep Analysis</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Comprehensive SEO & GEO audit covering titles, meta tags, headings, and AI-readiness.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-100 dark:border-gray-700">
              ...
              <h3 className="font-semibold text-lg mb-2 dark:text-white">Instant Results</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Get your SEO & GEO scores with actionable insights in seconds, not hours.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-100 dark:border-gray-700">
              ...
              <h3 className="font-semibold text-lg mb-2 dark:text-white">Clear Reports</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
