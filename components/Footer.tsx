        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Smarter SEO & GEO Insights. Optimize for traditional search engines and AI-powered platforms.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span className="text-sm">btehubsolutions@gmail.com</span>
              </a>
              <a
              ...
              >
                ...
                <span className="text-sm">btehubsolutions.vercel.app</span>
              </a>
            </div>
          </div>
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 hover:text-white transition-all duration-300 hover:scale-110"
        ...
        <div className="pt-8 border-t border-gray-200 dark:border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-600 dark:text-gray-400 text-center md:text-left">
              © {currentYear} OptiGenius. Built by{" "}
              <a
                href="https://btehubsolutions.vercel.app"
                target="_blank"
                rel="noopener noreferrer"
